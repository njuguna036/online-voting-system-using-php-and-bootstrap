...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <nav id="mainav" class="fl_right">
      ...
      <li class="active"><a href="electionResults.php">View Election Results</a></li>
          </ul>
        </li>
...
<div class="wrapper row4">
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_third">
      ...
      <ul class="nospace linklist contact">
        <li><i class="fa fa-phone"></i> +254 9650469951</li>
    ...
    <div class="one_third">
      ...
      <ul class="nospace linklist contact">  
        ...
        <li><i class="fa fa-envelope-o"></i> them@gmail.com </li>
      </ul>
    </div>
