...
<div  >
  ...
  if(empty($_SESSION['admin_id'])){
    ...
    if($ConfirmPassword == "")
    {
      ...
      $sql = "SELECT * from tbadministrators WHERE admin_id='" . $_SESSION['admin_id'] . "'";
    ...
    $result = $mysqli->query("UPDATE tbadministrators set password='" . $newpass . "' WHERE admin_id='" . $_SESSION['admin_id'] . "'");
...
<tr>
<form name="form1" method="post" action="changeAdminPassword.php" onSubmit="return validatePassword(this)">
<td>
<table style="background-color:powderblue;" width="100%" border="0" cellpadding="3" cellspacing="1" >
 ...
 <center>
      <br> <a href="manage-admins.php"><b>Go Back To Admin Portal</b></a>
      </center>
</div>
</div>
